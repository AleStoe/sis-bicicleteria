...
const styles = {
  ...
  layout: { display: "grid", gridTemplateColumns: "minmax(320px, 420px) minmax(0, 1fr)", gap: 16, alignItems: "start" },
  ...
  filters: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 10, alignItems: "center", padding: 16, borderBottom: "1px solid #e2e8f0", background: "#f8fafc" },
  contentGrid: { display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(280px, 320px)", alignItems: "stretch" },
