export const styles = {
  ...
  operatorMainAction: { marginTop: 14, border: "1px solid #fed7aa", background: "#fff7ed", borderRadius: 15, padding: 10, display: "grid", gap: 8 },
  operatorMainActionLabel: { color: "#c2410c", fontSize: 12, fontWeight: 1000, textTransform: "uppercase" },
  operatorPrimary: { width: "100%", border: "none", background: "#f97316", color: "white", borderRadius: 13, padding: "13px 16px", fontWeight: 1000, boxShadow: "0 10px 20px rgba(249,115,22,.22)" },
  ...
  quickActionsCard: { background: "white", border: "1px solid #fed7aa", borderRadius: 22, padding: 18, boxShadow: "0 14px 30px rgba(249,115,22,.10)", marginBottom: 16, display: "grid", gap: 14 },
  quickActionsTitle: { margin: "3px 0 0", color: "#0f172a", fontSize: 22, letterSpacing: "-.02em" },
